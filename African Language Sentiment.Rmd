...
This code loads the necessary packages for the analysis. The tidyverse package is used for data manipulation and visualization, ggforce for creating special graphics, ggsci for creating special color palettes, glue for combining strings and data together, ggtext for styling text, forcats for working with categorical variables, and showtext for improved rendering of text in plots.
